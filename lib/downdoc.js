 ...
 * @summary File -> File 
 */
var pluckAST = function (file) { 
  return extend(file, {
    doclets: file.ast.body
      .filter(isExport)
      // .map(function (x) { console.log(x); return x})
 ...
 * @summary File -> File
 */
var template = function (file) {
  return extend(file, {
    extension: '.md',
    content: file.doclets.map(function (doclet) {
